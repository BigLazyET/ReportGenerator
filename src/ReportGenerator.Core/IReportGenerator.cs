...
namespace Palmmedia.ReportGenerator.Core
{
    ...
    public interface IReportGenerator
    {
        ...
        (bool Result, SummaryResult Summary) GenerateReport(IReportConfiguration reportConfiguration);
        ...
        (bool Result, SummaryResult Summary) GenerateReport(
